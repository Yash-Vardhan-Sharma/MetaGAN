...
def main(
    ...
    writer = SummaryWriter("/home/sever2users/Desktop/MetaGAN/maml/viz/abalone")
    ...
    np.savetxt( '/home/sever2users/Desktop/MetaGAN/maml/test_results/abalone/{}way_{}shot_{}train_adp_steps.txt'.format(ways,shots,adaptation_steps), np.array(x))

    torch.save(maml_test.module.state_dict(), '/home/sever2users/Desktop/MetaGAN/maml/saved_models/abalone/state_dict_{}way_{}shot_{}train_adp_steps.pth'.format(ways,shots,adaptation_steps) )  
